.class public final Lz2/t5$OooOOO0;
...
# instance fields
.field private OooO0Oo:Landroid/view/WindowManager;

.field private OooO0o0:Landroid/view/WindowManager$LayoutParams;


# direct methods
.method public constructor <init>(Lz2/t5;I)V
    .locals 1
    ...
    iput-object p1, p0, Lz2/t5$OooOOO0;->OooO0o0:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object p1, p0, Lz2/t5$OooOOO0;->OooO0Oo:Landroid/view/WindowManager;

    iget-object p1, p0, Lz2/t5$OooOOO0;->OooO0o0:Landroid/view/WindowManager$LayoutParams;
...
.method public constructor <init>(Lz2/t5;Landroid/view/WindowManager;I)V
    .locals 0
    ...
    iput-object p2, p0, Lz2/t5$OooOOO0;->OooO0Oo:Landroid/view/WindowManager;
...
.method public OooO00o(I)V
    ...
    :cond_0
    iget-object v0, p0, Lz2/t5$OooOOO0;->OooO0o0:Landroid/view/WindowManager$LayoutParams;
    ...
    :try_start_0
    iget-object v0, p0, Lz2/t5$OooOOO0;->OooO0Oo:Landroid/view/WindowManager;

    if-eqz v0, :cond_3

    iget-object v1, p0, Lz2/t5$OooO0OO;->OooO0OO:Landroid/view/View;

    iget-object v2, p0, Lz2/t5$OooOOO0;->OooO0o0:Landroid/view/WindowManager$LayoutParams;
    ...
    :cond_3
    :goto_0
    new-instance v0, Lz2/t5$OooOOO0$OooO00o;

    invoke-direct {v0, p0}, Lz2/t5$OooOOO0$OooO00o;-><init>(Lz2/t5$OooOOO0;)V
...
.method public cancel()V
    ...
    iput-object v0, p0, Lz2/t5$OooOOO0;->OooO0Oo:Landroid/view/WindowManager;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
