...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lz2/o000000O$OooO00o;
    }
.end annotation


# static fields
.field private static final OooO0O0:Ljava/lang/String; = "Content-Type"


# instance fields
.field public final OooO00o:Lorg/apache/http/client/HttpClient;
...
.method public constructor <init>(Lorg/apache/http/client/HttpClient;)V
    ...
    iput-object p1, p0, Lz2/o000000O;->OooO00o:Lorg/apache/http/client/HttpClient;

    return-void
.end method

.method private static OooO0O0(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    .locals 3
...
.method public static OooO0OO(Lcom/android/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lcom/android/volley/Request;->OooOOOo()I
    ...
    :pswitch_0
    new-instance p1, Lz2/o000000O$OooO00o;

    invoke-virtual {p0}, Lcom/android/volley/Request;->OooOoo()Ljava/lang/String;

    move-result-object v1

    invoke-direct {p1, v1}, Lz2/o000000O$OooO00o;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {p1, p0}, Lz2/o000000O;->OooO0o(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/android/volley/Request;)V
    ...
    :pswitch_8
    invoke-virtual {p0}, Lcom/android/volley/Request;->OooOOoo()[B
    ...
    invoke-virtual {p0}, Lcom/android/volley/Request;->OooOo00()Ljava/lang/String;
...
.method private static OooO0Oo(Ljava/util/Map;)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static OooO0o(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/android/volley/Request;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public OooO00o(Lcom/android/volley/Request;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    ...
    invoke-static {p1, p2}, Lz2/o000000O;->OooO0OO(Lcom/android/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;

    move-result-object v0

    invoke-static {v0, p2}, Lz2/o000000O;->OooO0O0(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, v0}, Lz2/o000000O;->OooO0o0(Lorg/apache/http/client/methods/HttpUriRequest;)V
    ...
    iget-object p1, p0, Lz2/o000000O;->OooO00o:Lorg/apache/http/client/HttpClient;
...
.method public OooO0o0(Lorg/apache/http/client/methods/HttpUriRequest;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
