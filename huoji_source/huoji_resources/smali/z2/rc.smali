...
# static fields
.field private static final OooO0OO:Ljava/lang/String; = "rc"

.field private static OooO0Oo:Lz2/rc;


# instance fields
.field private OooO0O0:Lz2/rc$OooO00o;
...
.method private OooO(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Lz2/rc;->OooO0O0:Lz2/rc$OooO00o;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lz2/rc$OooO00o;->OooO00o(ILjava/lang/String;)V

    :cond_0
    return-void
.end method

.method public static OooO0oO()Lz2/rc;
    .locals 2

    sget-object v0, Lz2/rc;->OooO0Oo:Lz2/rc;

    if-nez v0, :cond_1

    const-class v0, Lz2/rc;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lz2/rc;->OooO0Oo:Lz2/rc;

    if-nez v1, :cond_0

    new-instance v1, Lz2/rc;

    invoke-direct {v1}, Lz2/rc;-><init>()V

    sput-object v1, Lz2/rc;->OooO0Oo:Lz2/rc;
...
.method public OooO00o(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lz2/rc;->OooO0O0:Lz2/rc$OooO00o;

    if-eqz v1, :cond_2

    invoke-interface {v1, p1}, Lz2/rc$OooO00o;->OooO0O0(Lcom/cyjh/http/bean/response/ProjectNumberInfo;)V

    goto :goto_1

    :cond_0
    invoke-direct {p0, p1, v2}, Lz2/rc;->OooO(ILjava/lang/String;)V
    :try_end_0
    ...
    :goto_0
    invoke-direct {p0, v0, p1}, Lz2/rc;->OooO(ILjava/lang/String;)V
...
.method public OooO0OO(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lz2/rc$OooO00o;)V
    .locals 1

    :try_start_0
    iput-object p7, p0, Lz2/rc;->OooO0O0:Lz2/rc$OooO00o;

    invoke-static {}, Lz2/gc;->OooO0OO()Lz2/gc;

    move-result-object p7

    invoke-virtual {p7, p1}, Lz2/gc;->OooO00o(Landroid/content/Context;)Lcom/cyjh/http/bean/request/BaseRequestValueInfo;
...
.method public OooOO0(Lz2/rc$OooO00o;)Lz2/rc;
    .locals 0

    iput-object p1, p0, Lz2/rc;->OooO0O0:Lz2/rc$OooO00o;

    return-object p0
.end method

.method public OooOO0O(Landroid/content/Context;Ljava/lang/String;Lz2/rc$OooO00o;)V
    .locals 2

    :try_start_0
    iput-object p3, p0, Lz2/rc;->OooO0O0:Lz2/rc$OooO00o;
