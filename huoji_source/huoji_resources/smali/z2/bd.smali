...
# static fields
.field private static final OooO0OO:Ljava/lang/String; = "bd"

.field private static OooO0Oo:Lz2/bd;


# instance fields
.field private OooO0O0:Lz2/bd$OooO00o;
...
.method public static OooO0o()Lz2/bd;
    .locals 2

    sget-object v0, Lz2/bd;->OooO0Oo:Lz2/bd;

    if-nez v0, :cond_1

    const-class v0, Lz2/bd;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lz2/bd;->OooO0Oo:Lz2/bd;

    if-nez v1, :cond_0

    new-instance v1, Lz2/bd;

    invoke-direct {v1}, Lz2/bd;-><init>()V

    sput-object v1, Lz2/bd;->OooO0Oo:Lz2/bd;
...
.method private OooO0oo(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Lz2/bd;->OooO0O0:Lz2/bd$OooO00o;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lz2/bd$OooO00o;->OooO00o(ILjava/lang/String;)V
...
# virtual methods
.method public OooO(Lz2/bd$OooO00o;)Lz2/bd;
    .locals 0

    iput-object p1, p0, Lz2/bd;->OooO0O0:Lz2/bd$OooO00o;
...
.method public OooO00o(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lz2/bd;->OooO0O0:Lz2/bd$OooO00o;

    if-eqz p1, :cond_2

    invoke-interface {p1, v1}, Lz2/bd$OooO00o;->OooO0O0(Ljava/lang/String;)V

    goto :goto_1

    :cond_0
    invoke-direct {p0, p1, v1}, Lz2/bd;->OooO0oo(ILjava/lang/String;)V
    :try_end_0
    ...
    :goto_0
    invoke-direct {p0, v0, p1}, Lz2/bd;->OooO0oo(ILjava/lang/String;)V
...
.method public OooOO0(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lz2/bd$OooO00o;)V
    .locals 1

    :try_start_0
    iput-object p5, p0, Lz2/bd;->OooO0O0:Lz2/bd$OooO00o;

    invoke-static {}, Lz2/gc;->OooO0OO()Lz2/gc;

    move-result-object p5

    invoke-virtual {p5, p1}, Lz2/gc;->OooO00o(Landroid/content/Context;)Lcom/cyjh/http/bean/request/BaseRequestValueInfo;
