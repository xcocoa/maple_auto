...
# virtual methods
.method public checkTerminated(ZZZLz2/yc0;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Lz2/yc0;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_2
    invoke-interface {p4}, Lz2/yc0;->onComplete()V
...
.method public drain()V
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lz2/yc0;)V

    goto :goto_0

    :cond_2
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lz2/yc0;)V
...
.method public drainFused(Lz2/yc0;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-interface {p1, v4}, Lz2/yc0;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Lz2/yc0;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLz2/yc0;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    :cond_2
    invoke-interface {v5, v8}, Lz2/yc0;->onNext(Ljava/lang/Object;)V
