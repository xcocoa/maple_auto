...
.method public static checkTerminated(ZZLz2/yc0;ZLio/reactivex/internal/fuseable/SimpleQueue;Lio/reactivex/internal/util/QueueDrain;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p2, p0}, Lz2/yc0;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_1
    invoke-interface {p2}, Lz2/yc0;->onComplete()V
...
.method public static drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lz2/yc0;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static/range {v2 .. v7}, Lio/reactivex/internal/util/QueueDrainHelper;->checkTerminated(ZZLz2/yc0;ZLio/reactivex/internal/fuseable/SimpleQueue;Lio/reactivex/internal/util/QueueDrain;)Z
    ...
    invoke-interface {p4, p1, v8}, Lio/reactivex/internal/util/QueueDrain;->accept(Lz2/yc0;Ljava/lang/Object;)Z
    ...
    invoke-interface {p1, p0}, Lz2/yc0;->onError(Ljava/lang/Throwable;)V
...
.method public static postComplete(Lz2/yc0;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p0}, Lz2/yc0;->onComplete()V
    ...
    invoke-static/range {v1 .. v6}, Lio/reactivex/internal/util/QueueDrainHelper;->postCompleteDrain(JLz2/yc0;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    ...
    invoke-static/range {v9 .. v14}, Lio/reactivex/internal/util/QueueDrainHelper;->postCompleteDrain(JLz2/yc0;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z

    :cond_3
    return-void
.end method

.method public static postCompleteDrain(JLz2/yc0;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :cond_2
    invoke-interface {p2, v5}, Lz2/yc0;->onNext(Ljava/lang/Object;)V
...
.method public static postCompleteRequest(JLz2/yc0;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static/range {v8 .. v13}, Lio/reactivex/internal/util/QueueDrainHelper;->postCompleteDrain(JLz2/yc0;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
...
.method public static request(Lz2/zc0;I)V
    .locals 2
    ...
    :goto_0
    invoke-interface {p0, v0, v1}, Lz2/zc0;->request(J)V
