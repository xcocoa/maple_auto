...
.method public static subscribe(Lz2/yc0;Ljava/util/Iterator;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->complete(Lz2/yc0;)V
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorSubscription;-><init>(Lz2/yc0;Ljava/util/Iterator;)V

    :goto_0
    invoke-interface {p0, v0}, Lz2/yc0;->onSubscribe(Lz2/zc0;)V
    ...
    invoke-static {p1, p0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lz2/yc0;)V
...
.method public subscribeActual(Lz2/yc0;)V
    ...
    invoke-static {p1, v0}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable;->subscribe(Lz2/yc0;Ljava/util/Iterator;)V
