...
# direct methods
.method public constructor <init>(Lz2/yc0;Lio/reactivex/functions/Function;IIZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lz2/yc0;
...
.method public drainAsync()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lz2/yc0;
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLz2/yc0;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLz2/yc0;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
...
.method public drainOutput()V
    ...
    invoke-interface {v0, v3}, Lz2/yc0;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v5}, Lz2/yc0;->onNext(Ljava/lang/Object;)V
...
.method public subscribe([Lz2/xc0;I)V
    ...
    invoke-interface {v2, v3}, Lz2/xc0;->subscribe(Lz2/yc0;)V
