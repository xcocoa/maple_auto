...
# direct methods
.method public constructor <init>(Lz2/yc0;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;-><init>(Lz2/yc0;Lio/reactivex/internal/fuseable/SimplePlainQueue;)V
...
# virtual methods
.method public bridge synthetic accept(Lz2/yc0;Ljava/lang/Object;)Z
    .locals 0

    check-cast p2, Ljava/util/Collection;

    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->accept(Lz2/yc0;Ljava/util/Collection;)Z
...
.method public accept(Lz2/yc0;Ljava/util/Collection;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lz2/yc0;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->upstream:Lz2/zc0;
...
.method public next()V
    ...
    invoke-interface {v1, v2}, Lz2/xc0;->subscribe(Lz2/yc0;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->upstream:Lz2/zc0;

    invoke-interface {v1}, Lz2/zc0;->cancel()V

    :goto_1
    iget-object v1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lz2/yc0;
...
.method public onComplete()V
    ...
    invoke-static {v0, v1, v2, p0, p0}, Lio/reactivex/internal/util/QueueDrainHelper;->drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lz2/yc0;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lz2/yc0;
...
.method public onSubscribe(Lz2/zc0;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->upstream:Lz2/zc0;
    ...
    invoke-interface {p1, v3, v4}, Lz2/zc0;->request(J)V

    invoke-interface {v2, v1}, Lz2/xc0;->subscribe(Lz2/yc0;)V
    ...
    invoke-static {v2, v0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lz2/yc0;)V
