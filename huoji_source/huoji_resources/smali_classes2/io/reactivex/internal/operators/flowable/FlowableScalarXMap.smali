...
.method public static tryScalarXMapSubscribe(Lz2/xc0;Lz2/yc0;Lio/reactivex/functions/Function;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {p2, p1, p0}, Lio/reactivex/internal/subscriptions/ScalarSubscription;-><init>(Lz2/yc0;Ljava/lang/Object;)V

    invoke-interface {p1, p2}, Lz2/yc0;->onSubscribe(Lz2/zc0;)V
    ...
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lz2/yc0;)V

    return v0

    :cond_2
    invoke-interface {p0, p1}, Lz2/xc0;->subscribe(Lz2/yc0;)V
