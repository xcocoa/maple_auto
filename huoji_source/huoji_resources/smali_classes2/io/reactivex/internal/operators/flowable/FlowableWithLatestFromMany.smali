...
.field public final otherArray:[Lz2/xc0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Lz2/xc0<",
...
.method public constructor <init>(Lio/reactivex/Flowable;Ljava/lang/Iterable;Lio/reactivex/functions/Function;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherArray:[Lz2/xc0;
...
.method public constructor <init>(Lio/reactivex/Flowable;[Lz2/xc0;Lio/reactivex/functions/Function;)V
    .locals 0
    .param p1    # Lio/reactivex/Flowable;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherArray:[Lz2/xc0;
...
.method public subscribeActual(Lz2/yc0;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherArray:[Lz2/xc0;
    ...
    invoke-virtual {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableMap;->subscribeActual(Lz2/yc0;)V
    ...
    invoke-direct {v1, p1, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;-><init>(Lz2/yc0;Lio/reactivex/functions/Function;I)V

    invoke-interface {p1, v1}, Lz2/yc0;->onSubscribe(Lz2/zc0;)V

    invoke-virtual {v1, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;->subscribe([Lz2/xc0;I)V
