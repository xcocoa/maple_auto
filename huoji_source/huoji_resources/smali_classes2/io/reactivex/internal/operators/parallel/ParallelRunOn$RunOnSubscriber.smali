...
# direct methods
.method public constructor <init>(Lz2/yc0;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lz2/yc0;
...
.method public onSubscribe(Lz2/zc0;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lz2/zc0;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lz2/zc0;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lz2/yc0;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lz2/yc0;
    ...
    invoke-interface {v3, v15}, Lz2/yc0;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_6
    invoke-interface {v3, v15}, Lz2/yc0;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lz2/zc0;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lz2/zc0;->request(J)V
