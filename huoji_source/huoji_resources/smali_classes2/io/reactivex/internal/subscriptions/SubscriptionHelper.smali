...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    check-cast p0, Lz2/zc0;

    if-eq p0, v1, :cond_1

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lz2/zc0;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    invoke-interface {v0, p2, p3}, Lz2/zc0;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lz2/zc0;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lz2/zc0;)Z
    ...
    invoke-interface {p2, p0, p1}, Lz2/zc0;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lz2/zc0;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lz2/zc0;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lz2/zc0;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lz2/zc0;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lz2/zc0;)Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-interface {p1, p2, p3}, Lz2/zc0;->request(J)V
...
.method public static validate(Lz2/zc0;Lz2/zc0;)Z
    .locals 1
