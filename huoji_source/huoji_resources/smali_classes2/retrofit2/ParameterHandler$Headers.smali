...
.method public bridge synthetic apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    check-cast p2, Lz2/jx;

    invoke-virtual {p0, p1, p2}, Lretrofit2/ParameterHandler$Headers;->apply(Lretrofit2/RequestBuilder;Lz2/jx;)V

    return-void
.end method

.method public apply(Lretrofit2/RequestBuilder;Lz2/jx;)V
    .locals 2
    .param p2    # Lz2/jx;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p1, p2}, Lretrofit2/RequestBuilder;->addHeaders(Lz2/jx;)V
