...
.field private callFactory:Lz2/tw$OooO00o;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Lretrofit2/Retrofit;)V
    ...
    iget-object v1, p1, Lretrofit2/Retrofit;->callFactory:Lz2/tw$OooO00o;

    iput-object v1, p0, Lretrofit2/Retrofit$Builder;->callFactory:Lz2/tw$OooO00o;

    iget-object v1, p1, Lretrofit2/Retrofit;->baseUrl:Lz2/kx;

    iput-object v1, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lz2/kx;
...
.method public baseUrl(Ljava/lang/String;)Lretrofit2/Retrofit$Builder;
    ...
    invoke-virtual {p0, p1}, Lretrofit2/Retrofit$Builder;->baseUrl(Lz2/kx;)Lretrofit2/Retrofit$Builder;
...
.method public baseUrl(Lz2/kx;)Lretrofit2/Retrofit$Builder;
    .locals 3
    ...
    invoke-virtual {p1}, Lz2/kx;->OooOo0o()Ljava/util/List;
    ...
    iput-object p1, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lz2/kx;
...
.method public build()Lretrofit2/Retrofit;
    ...
    iget-object v0, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lz2/kx;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lretrofit2/Retrofit$Builder;->callFactory:Lz2/tw$OooO00o;

    if-nez v0, :cond_0

    new-instance v0, Lz2/ox;

    invoke-direct {v0}, Lz2/ox;-><init>()V
    ...
    iget-object v3, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lz2/kx;
    ...
    invoke-direct/range {v1 .. v7}, Lretrofit2/Retrofit;-><init>(Lz2/tw$OooO00o;Lz2/kx;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/Executor;Z)V
...
.method public callFactory(Lz2/tw$OooO00o;)Lretrofit2/Retrofit$Builder;
    .locals 1
    ...
    check-cast p1, Lz2/tw$OooO00o;

    iput-object p1, p0, Lretrofit2/Retrofit$Builder;->callFactory:Lz2/tw$OooO00o;
...
.method public client(Lz2/ox;)Lretrofit2/Retrofit$Builder;
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lretrofit2/Retrofit$Builder;->callFactory(Lz2/tw$OooO00o;)Lretrofit2/Retrofit$Builder;
