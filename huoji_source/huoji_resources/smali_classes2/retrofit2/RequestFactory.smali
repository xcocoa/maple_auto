...
.field private final headers:Lz2/jx;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:Lz2/kx;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:Lz2/kx;
    ...
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:Lz2/jx;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:Lz2/jx;

    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:Lz2/mx;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:Lz2/mx;
...
# virtual methods
.method public create([Ljava/lang/Object;)Lz2/qx;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:Lz2/kx;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:Lz2/jx;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:Lz2/mx;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lz2/kx;Ljava/lang/String;Lz2/jx;Lz2/mx;ZZZ)V
    ...
    :cond_1
    invoke-virtual {v2}, Lretrofit2/RequestBuilder;->get()Lz2/qx$OooO00o;
    ...
    invoke-virtual {p1, v0, v1}, Lz2/qx$OooO00o;->OooOOOO(Ljava/lang/Class;Ljava/lang/Object;)Lz2/qx$OooO00o;
