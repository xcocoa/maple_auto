...
# static fields
.field private static final OooO00o:I = 0x4
...
.method private static OooO0OO(Lz2/rt;III)Lz2/eo;
    .locals 9

    invoke-virtual {p0}, Lz2/rt;->OooO0OO()Lz2/nt;
    ...
    invoke-virtual {p0, v6, p2}, Lz2/nt;->OooO0O0(II)B

    move-result v8

    if-ne v8, v2, :cond_0

    invoke-virtual {v5, v7, v4, p3, p3}, Lz2/eo;->OooOOo(IIII)V
...
.method public final OooO0O0(Ljava/lang/String;Lcom/google/zxing/BarcodeFormat;IILjava/util/Map;)Lz2/eo;
    ...
    :cond_1
    invoke-static {p1, p2, p5}, Lz2/ot;->OooOOOo(Ljava/lang/String;Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;Ljava/util/Map;)Lz2/rt;

    move-result-object p1

    invoke-static {p1, p3, p4, v0}, Lz2/zs;->OooO0OO(Lz2/rt;III)Lz2/eo;
