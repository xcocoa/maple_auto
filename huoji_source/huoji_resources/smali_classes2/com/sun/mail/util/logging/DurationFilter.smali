...
.method private declared-synchronized accept(J)Z
    ...
    iget-wide v5, p0, Lcom/sun/mail/util/logging/DurationFilter;->duration:J

    cmp-long v7, v0, v5

    if-ltz v7, :cond_2

    iput-wide v3, p0, Lcom/sun/mail/util/logging/DurationFilter;->count:J
...
.method private initLong(Ljava/lang/String;)J
    ...
    invoke-static {v1, v2, v5, v6}, Lcom/sun/mail/util/logging/DurationFilter;->multiplyExact(JJ)J
