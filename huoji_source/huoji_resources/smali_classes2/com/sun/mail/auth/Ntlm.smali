...
.method public generateType3Msg(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v14, v1, Lcom/sun/mail/auth/Ntlm;->ntdomain:Ljava/lang/String;

    const/16 v8, 0x40

    invoke-direct {v1, v2, v8, v14, v0}, Lcom/sun/mail/auth/Ntlm;->copybytes([BILjava/lang/String;Ljava/lang/String;)V

    iget-object v2, v1, Lcom/sun/mail/auth/Ntlm;->type3:[B

    const/16 v14, 0x20

    invoke-direct {v1, v2, v14, v8}, Lcom/sun/mail/auth/Ntlm;->writeInt([BII)V
    ...
    invoke-static {v13, v3, v2, v8, v7}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
