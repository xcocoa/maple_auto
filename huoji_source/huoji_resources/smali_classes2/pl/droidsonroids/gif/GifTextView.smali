...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p2, p1, p1}, Lpl/droidsonroids/gif/GifTextView;->OooO0OO(Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p2, p3, p1}, Lpl/droidsonroids/gif/GifTextView;->OooO0OO(Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, p2, p3, p4}, Lpl/droidsonroids/gif/GifTextView;->OooO0OO(Landroid/util/AttributeSet;II)V
...
.method private OooO00o()V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/GifTextView;->OoooOoO:Lz2/kd0$OooO0O0;
    ...
    iget-object v5, p0, Lpl/droidsonroids/gif/GifTextView;->OoooOoO:Lz2/kd0$OooO0O0;

    iget v5, v5, Lz2/kd0$OooO0O0;->OooO0O0:I

    invoke-static {v5, v4}, Lz2/kd0;->OooO00o(ILandroid/graphics/drawable/Drawable;)V
    ...
    iget-object v4, p0, Lpl/droidsonroids/gif/GifTextView;->OoooOoO:Lz2/kd0$OooO0O0;

    iget v4, v4, Lz2/kd0$OooO0O0;->OooO0O0:I

    invoke-static {v4, v3}, Lz2/kd0;->OooO00o(ILandroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v0, v1}, Lz2/kd0;->OooO00o(ILandroid/graphics/drawable/Drawable;)V

    return-void
.end method

.method private OooO0O0(I)Landroid/graphics/drawable/Drawable;
    .locals 3
    ...
    :try_start_0
    new-instance v1, Lz2/ed0;

    invoke-direct {v1, v0, p1}, Lz2/ed0;-><init>(Landroid/content/res/Resources;I)V
    :try_end_0
...
.method private OooO0OO(Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, v1}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v3}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v4}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v5}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v6}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v7}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v0}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lpl/droidsonroids/gif/GifTextView;->OoooOoO:Lz2/kd0$OooO0O0;

    invoke-direct {p0}, Lpl/droidsonroids/gif/GifTextView;->OooO00o()V
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/GifTextView;->OoooOoO:Lz2/kd0$OooO0O0;

    return-void
.end method

.method private static OooO0Oo([Landroid/graphics/drawable/Drawable;Z)V
    .locals 4
...
.method private setCompoundDrawablesVisible(Z)V
    ...
    invoke-static {v0, p1}, Lpl/droidsonroids/gif/GifTextView;->OooO0Oo([Landroid/graphics/drawable/Drawable;Z)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Lpl/droidsonroids/gif/GifTextView;->OoooOoO:Lz2/kd0$OooO0O0;

    iget-boolean v1, v1, Lz2/kd0$OooO0O0;->OooO00o:Z
...
.method public setBackgroundResource(I)V
    ...
    invoke-direct {p0, p1}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;
...
.method public setCompoundDrawablesRelativeWithIntrinsicBounds(IIII)V
    ...
    invoke-direct {p0, p2}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-direct {p0, p3}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    invoke-direct {p0, p4}, Lpl/droidsonroids/gif/GifTextView;->OooO0O0(I)Landroid/graphics/drawable/Drawable;
