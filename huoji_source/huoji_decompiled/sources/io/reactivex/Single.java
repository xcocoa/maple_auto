...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> concat(xc0<? extends SingleSource<? extends T>> xc0Var) {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> concat(xc0<? extends SingleSource<? extends T>> xc0Var, int i) {
        ObjectHelper.requireNonNull(xc0Var, "sources is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(xc0Var, SingleInternalHelper.toFlowable(), i, ErrorMode.IMMEDIATE));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> concatEager(xc0<? extends SingleSource<? extends T>> xc0Var) {
        return Flowable.fromPublisher(xc0Var).concatMapEager(SingleInternalHelper.toFlowable());
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Single<T> fromPublisher(xc0<? extends T> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "publisher is null");
        return RxJavaPlugins.onAssembly(new SingleFromPublisher(xc0Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> merge(xc0<? extends SingleSource<? extends T>> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "sources is null");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(xc0Var, SingleInternalHelper.toFlowable(), false, Integer.MAX_VALUE, Flowable.bufferSize()));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> mergeDelayError(xc0<? extends SingleSource<? extends T>> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "sources is null");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(xc0Var, SingleInternalHelper.toFlowable(), true, Integer.MAX_VALUE, Flowable.bufferSize()));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Single<T> delaySubscription(xc0<U> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "other is null");
        return RxJavaPlugins.onAssembly(new SingleDelayWithPublisher(this, xc0Var));
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Single<T> retryWhen(Function<? super Flowable<Throwable>, ? extends xc0<?>> function) {
    ...
    @CheckReturnValue
    @NonNull
    public final <E> Single<T> takeUntil(xc0<E> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "other is null");
        return RxJavaPlugins.onAssembly(new SingleTakeUntil(this, xc0Var));
    }
