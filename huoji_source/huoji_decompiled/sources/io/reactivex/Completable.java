...
public abstract class Completable implements CompletableSource {
    ...
    @CheckReturnValue
    public static Completable concat(xc0<? extends CompletableSource> xc0Var) {
    ...
    @CheckReturnValue
    @NonNull
    public static Completable concat(xc0<? extends CompletableSource> xc0Var, int i) {
        ObjectHelper.requireNonNull(xc0Var, "sources is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        return RxJavaPlugins.onAssembly(new CompletableConcat(xc0Var, i));
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Completable fromPublisher(xc0<T> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "publisher is null");
        return RxJavaPlugins.onAssembly(new CompletableFromPublisher(xc0Var));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public static Completable merge(xc0<? extends CompletableSource> xc0Var) {
        return merge0(xc0Var, Integer.MAX_VALUE, false);
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static Completable merge(xc0<? extends CompletableSource> xc0Var, int i) {
        return merge0(xc0Var, i, false);
    }
    ...
    @CheckReturnValue
    @NonNull
    private static Completable merge0(xc0<? extends CompletableSource> xc0Var, int i, boolean z) {
        ObjectHelper.requireNonNull(xc0Var, "sources is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new CompletableMerge(xc0Var, i, z));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public static Completable mergeDelayError(xc0<? extends CompletableSource> xc0Var) {
        return merge0(xc0Var, Integer.MAX_VALUE, true);
    }

    @SchedulerSupport(SchedulerSupport.NONE)
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static Completable mergeDelayError(xc0<? extends CompletableSource> xc0Var, int i) {
        return merge0(xc0Var, i, true);
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <T> Flowable<T> andThen(xc0<T> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "next is null");
        return RxJavaPlugins.onAssembly(new CompletableAndThenPublisher(this, xc0Var));
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Completable repeatWhen(Function<? super Flowable<Object>, ? extends xc0<?>> function) {
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Completable retryWhen(Function<? super Flowable<Throwable>, ? extends xc0<?>> function) {
    ...
    @CheckReturnValue
    @NonNull
    public final <T> Flowable<T> startWith(xc0<T> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "other is null");
        return toFlowable().startWith((xc0) xc0Var);
    }
