...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concat(xc0<? extends MaybeSource<? extends T>> xc0Var) {
        return concat(xc0Var, 2);
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> concat(xc0<? extends MaybeSource<? extends T>> xc0Var, int i) {
        ObjectHelper.requireNonNull(xc0Var, "sources is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(xc0Var, MaybeToPublisher.instance(), i, ErrorMode.IMMEDIATE));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatDelayError(xc0<? extends MaybeSource<? extends T>> xc0Var) {
        return Flowable.fromPublisher(xc0Var).concatMapDelayError(MaybeToPublisher.instance());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatEager(xc0<? extends MaybeSource<? extends T>> xc0Var) {
        return Flowable.fromPublisher(xc0Var).concatMapEager(MaybeToPublisher.instance());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> merge(xc0<? extends MaybeSource<? extends T>> xc0Var) {
        return merge(xc0Var, Integer.MAX_VALUE);
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> merge(xc0<? extends MaybeSource<? extends T>> xc0Var, int i) {
        ObjectHelper.requireNonNull(xc0Var, "source is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(xc0Var, MaybeToPublisher.instance(), false, i, 1));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> mergeDelayError(xc0<? extends MaybeSource<? extends T>> xc0Var) {
        return mergeDelayError(xc0Var, Integer.MAX_VALUE);
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> mergeDelayError(xc0<? extends MaybeSource<? extends T>> xc0Var, int i) {
        ObjectHelper.requireNonNull(xc0Var, "source is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(xc0Var, MaybeToPublisher.instance(), true, i, 1));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U, V> Maybe<T> delay(xc0<U> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "delayIndicator is null");
        return RxJavaPlugins.onAssembly(new MaybeDelayOtherPublisher(this, xc0Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> delaySubscription(xc0<U> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "subscriptionIndicator is null");
        return RxJavaPlugins.onAssembly(new MaybeDelaySubscriptionOtherPublisher(this, xc0Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <R> Flowable<R> flatMapPublisher(Function<? super T, ? extends xc0<? extends R>> function) {
        ObjectHelper.requireNonNull(function, "mapper is null");
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @CheckReturnValue
    public final Maybe<T> retryWhen(Function<? super Flowable<Throwable>, ? extends xc0<?>> function) {
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> takeUntil(xc0<U> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "other is null");
        return RxJavaPlugins.onAssembly(new MaybeTakeUntilPublisher(this, xc0Var));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> timeout(xc0<U> xc0Var) {
        ObjectHelper.requireNonNull(xc0Var, "timeoutIndicator is null");
        return RxJavaPlugins.onAssembly(new MaybeTimeoutPublisher(this, xc0Var, null));
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <U> Maybe<T> timeout(xc0<U> xc0Var, MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(xc0Var, "timeoutIndicator is null");
        ObjectHelper.requireNonNull(maybeSource, "fallback is null");
        return RxJavaPlugins.onAssembly(new MaybeTimeoutPublisher(this, xc0Var, maybeSource));
    }
