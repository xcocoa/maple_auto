...
public final class Disposables {
    ...
    @NonNull
    public static Disposable fromSubscription(@NonNull zc0 zc0Var) {
        ObjectHelper.requireNonNull(zc0Var, "subscription is null");
        return new SubscriptionDisposable(zc0Var);
    }
}
