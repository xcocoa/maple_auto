...
public final class Functions {
    ...
    public static final Consumer<zc0> REQUEST_MAX = new MaxRequestSubscription();
    ...
    public static class BoundedConsumer implements Consumer<zc0> {
    ...
    public static final class MaxRequestSubscription implements Consumer<zc0> {
        @Override // io.reactivex.functions.Consumer
        public void accept(zc0 zc0Var) throws Exception {
