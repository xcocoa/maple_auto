...
public final class SingleInternalHelper {
    ...
    public enum ToFlowable implements Function<SingleSource, xc0> {
        INSTANCE;

        @Override // io.reactivex.functions.Function
        public xc0 apply(SingleSource singleSource) {
    ...
    public static <T> Function<SingleSource<? extends T>, xc0<? extends T>> toFlowable() {
