...
public final class BlockingFlowableNext<T> implements Iterable<T> {
    ...
    public static final class NextIterator<T> implements Iterator<T> {
        ...
        private final xc0<? extends T> items;
        private T next;
        private boolean started;
        private final NextSubscriber<T> subscriber;

        public NextIterator(xc0<? extends T> xc0Var, NextSubscriber<T> nextSubscriber) {
            this.items = xc0Var;
    ...
    public BlockingFlowableNext(xc0<? extends T> xc0Var) {
        this.source = xc0Var;
    }
