...
public final class FlowableFilter<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public static final class FilterSubscriber<T> extends BasicFuseableSubscriber<T, T> implements ConditionalSubscriber<T> {
        ...
        public FilterSubscriber(yc0<? super T> yc0Var, Predicate<? super T> predicate) {
            super(yc0Var);
            this.filter = predicate;
        }
    ...
    public void subscribeActual(yc0<? super T> yc0Var) {
        ...
        if (yc0Var instanceof ConditionalSubscriber) {
            ...
            filterSubscriber = new FilterConditionalSubscriber<>((ConditionalSubscriber) yc0Var, this.predicate);
        } else {
            flowable = this.source;
            filterSubscriber = new FilterSubscriber<>(yc0Var, this.predicate);
        }
