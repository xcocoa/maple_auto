...
public final class FlowableFlatMapCompletable<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public static final class FlatMapCompletableMainSubscriber<T> extends BasicIntQueueSubscription<T> implements FlowableSubscriber<T> {
        ...
        public FlatMapCompletableMainSubscriber(yc0<? super T> yc0Var, Function<? super T, ? extends CompletableSource> function, boolean z, int i) {
    ...
    public void subscribeActual(yc0<? super T> yc0Var) {
        this.source.subscribe((FlowableSubscriber) new FlatMapCompletableMainSubscriber(yc0Var, this.mapper, this.delayErrors, this.maxConcurrency));
    }
}
