...
public final class FlowableIntervalRange extends Flowable<Long> {
    ...
    public static final class IntervalRangeSubscriber extends AtomicLong implements zc0, Runnable {
        ...
        public IntervalRangeSubscriber(yc0<? super Long> yc0Var, long j, long j2) {
    ...
    public void subscribeActual(yc0<? super Long> yc0Var) {
        IntervalRangeSubscriber intervalRangeSubscriber = new IntervalRangeSubscriber(yc0Var, this.start, this.end);
        yc0Var.onSubscribe(intervalRangeSubscriber);
