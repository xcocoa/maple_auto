...
public final class FlowableFromArray<T> extends Flowable<T> {
    ...
    public static final class ArraySubscription<T> extends BaseArraySubscription<T> {
        ...
        public ArraySubscription(yc0<? super T> yc0Var, T[] tArr) {
            super(tArr);
        ...
        public void fastPath() {
            ...
            for (int i = this.index; i != length; i++) {
                ...
                T t = tArr[i];
                if (t == null) {
                    yc0Var.onError(new NullPointerException("array element is null"));
                    return;
                }
                yc0Var.onNext(t);
            }
    ...
    public void subscribeActual(yc0<? super T> yc0Var) {
        yc0Var.onSubscribe(yc0Var instanceof ConditionalSubscriber ? new ArrayConditionalSubscription((ConditionalSubscriber) yc0Var, this.array) : new ArraySubscription(yc0Var, this.array));
    }
}
