...
public final class MaybeTakeUntilPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    public static final class TakeUntilMainMaybeObserver<T, U> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        public static final class TakeUntilOtherMaybeObserver<U> extends AtomicReference<zc0> implements FlowableSubscriber<U> {
    ...
    public MaybeTakeUntilPublisher(MaybeSource<T> maybeSource, xc0<U> xc0Var) {
        super(maybeSource);
        this.other = xc0Var;
    }
