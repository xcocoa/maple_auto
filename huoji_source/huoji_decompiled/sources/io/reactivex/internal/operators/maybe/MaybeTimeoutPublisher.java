...
public final class MaybeTimeoutPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    public static final class TimeoutOtherMaybeObserver<T, U> extends AtomicReference<zc0> implements FlowableSubscriber<Object> {
        private static final long serialVersionUID = 8663801314800248617L;
    ...
    public MaybeTimeoutPublisher(MaybeSource<T> maybeSource, xc0<U> xc0Var, MaybeSource<? extends T> maybeSource2) {
        super(maybeSource);
        this.other = xc0Var;
