...
public final class RxJavaPlugins {
    ...
    @Nullable
    public static volatile BiFunction<? super Flowable, ? super yc0, ? extends yc0> onFlowableSubscribe;
    ...
    @Nullable
    public static BiFunction<? super Flowable, ? super yc0, ? extends yc0> getOnFlowableSubscribe() {
    ...
    @NonNull
    public static <T> yc0<? super T> onSubscribe(@NonNull Flowable<T> flowable, @NonNull yc0<? super T> yc0Var) {
        BiFunction<? super Flowable, ? super yc0, ? extends yc0> biFunction = onFlowableSubscribe;
        return biFunction != null ? (yc0) apply(biFunction, flowable, yc0Var) : yc0Var;
    }
    ...
    public static void setOnFlowableSubscribe(@Nullable BiFunction<? super Flowable, ? super yc0, ? extends yc0> biFunction) {
        if (lockdown) {
            throw new IllegalStateException("Plugins can't be changed anymore");
        }
