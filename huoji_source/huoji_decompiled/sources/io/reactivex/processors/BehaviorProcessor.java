...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    public static final class BehaviorSubscription<T> extends AtomicLong implements zc0, AppendOnlyLinkedArrayList.NonThrowingPredicate<Object> {
        ...
        public BehaviorSubscription(yc0<? super T> yc0Var, BehaviorProcessor<T> behaviorProcessor) {
    ...
    public void subscribeActual(yc0<? super T> yc0Var) {
        BehaviorSubscription<T> behaviorSubscription = new BehaviorSubscription<>(yc0Var, this);
        yc0Var.onSubscribe(behaviorSubscription);
