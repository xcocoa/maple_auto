...
public class AppCompatTextViewAutoSizeHelper {
    ...
    private boolean suggestedSizeFitsInSpace(int i, RectF rectF) {
        ...
        int maxLines = i2 >= 16 ? this.mTextView.getMaxLines() : -1;
        ...
        StaticLayout staticLayoutCreateStaticLayoutForMeasuring = i2 >= 23 ? createStaticLayoutForMeasuring(text, alignment, Math.round(rectF.right), maxLines) : createStaticLayoutForMeasuringPre23(text, alignment, Math.round(rectF.right));
