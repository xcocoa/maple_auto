...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int i = rect.left;
            this.mSearchSrcTextView.setDropDownHorizontalOffset(zIsLayoutRtl ? -i : paddingLeft - (i + dimensionPixelSize));
    ...
    public void onActionViewExpanded() {
        ...
        this.mSearchSrcTextView.setImeOptions(imeOptions | ne0.OoooOOo);
    ...
    */
    public void onMeasure(int i, int i2) {
        ...
        if (mode2 != Integer.MIN_VALUE) {
            ...
            } else if (mode2 == 1073741824 && (preferredWidth = this.mMaxWidth) > 0) {
            }
