    ...
    */
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ImageButton imageButton = this.mNavButtonView;
            if (z3) {
                iLayoutChildRight = layoutChildRight(imageButton, i20, iArr, iMin);
                ...
                if (!zShouldLayout || zShouldLayout2) {
                    ...
                    if (!z3) {
                        ...
                        if (zShouldLayout2) {
                            ...
                            int i27 = paddingTop + ((ViewGroup.MarginLayoutParams) layoutParams6).topMargin;
                            ...
                            int i28 = ((ViewGroup.MarginLayoutParams) layoutParams6).bottomMargin;
                        } else {
                            i14 = iMax;
                        }
                        if (z4) {
                        ...
                        for (i18 = 0; i18 < size2; i18++) {
                            iMin2 = layoutChildRight(this.mTempViews.get(i18), iMin2, iArr, i29);
                        }
                        addCustomViewsWithGravity(this.mTempViews, 1);
                        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
                        i19 = (i8 + (((i6 - i8) - i5) / 2)) - (viewListMeasuredWidth / 2);
                        int i30 = viewListMeasuredWidth + i19;
                        if (i19 >= iMax) {
                            iMax = i30 > iMin2 ? i19 - (i30 - iMin2) : i19;
                        }
                        size3 = this.mTempViews.size();
                        while (i11 < size3) {
                            iMax = layoutChildLeft(this.mTempViews.get(i11), iMax, iArr, i29);
                            i11++;
                        }
                        this.mTempViews.clear();
                    }
                    int i31 = (z4 ? this.mTitleMarginStart : 0) - iArr[1];
                    ...
                    if (zShouldLayout2) {
                        ...
                        this.mSubtitleTextView.layout(iMin2 - this.mSubtitleTextView.getMeasuredWidth(), i32, iMin2, this.mSubtitleTextView.getMeasuredHeight() + i32);
                ...
                i19 = (i8 + (((i6 - i8) - i5) / 2)) - (viewListMeasuredWidth2 / 2);
                int i302 = viewListMeasuredWidth2 + i19;
                if (i19 >= iMax) {
                }
                size3 = this.mTempViews.size();
                while (i11 < size3) {
        ...
        i19 = (i8 + (((i6 - i8) - i5) / 2)) - (viewListMeasuredWidth22 / 2);
        int i3022 = viewListMeasuredWidth22 + i19;
        if (i19 >= iMax) {
        }
        size3 = this.mTempViews.size();
        while (i11 < size3) {
