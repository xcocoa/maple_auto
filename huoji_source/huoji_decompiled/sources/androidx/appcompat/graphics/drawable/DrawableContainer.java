    ...
    public void animate(boolean z) {
        ...
        if (drawable != null) {
            ...
            if (j == 0) {
                ...
                drawable.setAlpha(((255 - (((int) ((j - jUptimeMillis) * 255)) / this.mDrawableContainerState.mEnterFadeDuration)) * this.mAlpha) / 255);
                z3 = true;
            }
        } else {
            this.mEnterAnimationEnd = 0L;
        ...
        if (drawable2 != null) {
            ...
            if (j2 == 0) {
                ...
                drawable2.setAlpha(((((int) ((j2 - jUptimeMillis) * 255)) / this.mDrawableContainerState.mExitFadeDuration) * this.mAlpha) / 255);
            }
        } else {
            this.mExitAnimationEnd = 0L;
            z4 = z3;
