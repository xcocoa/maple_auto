...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Type inference failed for: r2v20, types: [android.view.Window] */
    private ViewGroup createSubDecor() {
        ...
        if (this.mWindowNoTitle) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener(r02, new OnApplyWindowInsetsListener() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.3
                ...
                ((FitWindowsViewGroup) r02).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.4
    ...
    */
    private boolean onKeyUpPanel(int i, KeyEvent keyEvent) {
        ...
        if (zHideOverflowMenu) {
            AudioManager audioManager = (AudioManager) this.mContext.getSystemService(o.b);
