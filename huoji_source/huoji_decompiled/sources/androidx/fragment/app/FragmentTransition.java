...
public class FragmentTransition {
    ...
    */
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, BackStackRecord.Op op, SparseArray<FragmentContainerTransition> sparseArray, boolean z, boolean z3) {
        int i;
        boolean z4;
        boolean z5;
        boolean z6;
        ...
        if (i2 == 1) {
            ...
            boolean z10 = z3 ? !(!z9 || fragment.mHidden) : !(z9 || (view = fragment.mView) == null || view.getVisibility() != 0 || fragment.mPostponedAlpha < 0.0f);
            z6 = z10;
            z5 = false;
            z7 = true;
        } else if (i2 == 4) {
        ...
        if (z6 && (fragmentContainerTransitionEnsureContainer2 == null || fragmentContainerTransitionEnsureContainer2.firstOut == null)) {
        ...
        if (z3 || !z7 || fragmentContainerTransitionEnsureContainer2 == null || fragmentContainerTransitionEnsureContainer2.lastIn != fragment) {
            return;
        }
