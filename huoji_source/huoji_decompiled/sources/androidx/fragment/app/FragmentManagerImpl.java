...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Removed duplicated region for block: B:16:0x0031 A[PHI: r0 r2
      0x0031: PHI (r0v6 int) = (r0v4 int), (r0v3 int) binds: [B:29:0x006a, B:15:0x002f] A[DONT_GENERATE, DONT_INLINE]
      0x0031: PHI (r2v5 int) = (r2v2 int), (r2v1 int) binds: [B:29:0x006a, B:15:0x002f] A[DONT_GENERATE, DONT_INLINE]] */
    /*
    ...
    */
    public void moveToState(Fragment fragment, int i, int i2, int i3, boolean z) {
        ...
        if (fragment.mRemoving && i4 > (i5 = fragment.mState)) {
            i4 = (i5 == 0 && fragment.isInBackStack()) ? 1 : fragment.mState;
        }
                ...
                if (i8 != 1) {
                    ...
                    if (i7 < 2) {
                        ...
                        if (view != null && (viewGroup = fragment.mContainer) != null) {
                            ...
                            fragment.mPostponedAlpha = 0.0f;
                            if (animationOrAnimatorLoadAnimation != null) {
                                animateRemoveFragment(fragment, animationOrAnimatorLoadAnimation, i7);
                            }
        ...
        if (i9 != 0) {
            ...
            if (bundle != null) {
                ...
                Fragment fragment2 = getFragment(fragment.mSavedFragmentState, TARGET_STATE_TAG);
            ...
            fragment.mFragmentManager = fragment3 != null ? fragment3.mChildFragmentManager : fragmentHostCallback.getFragmentManagerImpl();
