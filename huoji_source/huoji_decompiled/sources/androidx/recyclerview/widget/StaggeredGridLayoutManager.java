    ...
    private void recycle(RecyclerView.Recycler recycler, LayoutState layoutState) {
        ...
        if (layoutState.mAvailable != 0) {
            if (layoutState.mLayoutDirection != -1) {
                ...
                int iMin = minEnd < 0 ? layoutState.mStartLine : Math.min(minEnd, layoutState.mAvailable) + layoutState.mStartLine;
                recycleFromStart(recycler, iMin);
            } else {
                int i = layoutState.mStartLine;
                int maxStart = i - getMaxStart(i);
                int iMin2 = maxStart < 0 ? layoutState.mEndLine : layoutState.mEndLine - Math.min(maxStart, layoutState.mAvailable);
