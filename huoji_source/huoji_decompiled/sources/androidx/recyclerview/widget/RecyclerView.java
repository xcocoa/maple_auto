...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public boolean isViewPartiallyVisible(@NonNull View view, boolean z, boolean z3) {
        ...
        */
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (layoutParams2 == null) {
                ...
                if (RecyclerView.this.checkLayoutParams(layoutParams2)) {
                    layoutParams = (LayoutParams) layoutParams2;
                    layoutParams.mInsetsDirty = true;
                    layoutParams.mViewHolder = childViewHolderInt;
                    layoutParams.mPendingInvalidate = childViewHolderInt.itemView.getParent() == null;
                }
                layoutParamsGenerateLayoutParams = RecyclerView.this.generateLayoutParams(layoutParams2);
            }
            layoutParams = (LayoutParams) layoutParamsGenerateLayoutParams;
    ...
    public static abstract class SmoothScroller {
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            if (this.mStarted) {
                Log.w(RecyclerView.TAG, "An instance of " + getClass().getSimpleName() + " was started more than once. Each instance of" + getClass().getSimpleName() + o4.OooO00o.OooO0Oo + "is intended to only be used once. You should create a new instance for each use.");
            }
            this.mRecyclerView = recyclerView;
    ...
    private void animateChange(@NonNull ViewHolder viewHolder, @NonNull ViewHolder viewHolder2, @NonNull ItemAnimator.ItemHolderInfo itemHolderInfo, @NonNull ItemAnimator.ItemHolderInfo itemHolderInfo2, boolean z, boolean z3) {
        viewHolder.setIsRecyclable(false);
        if (z) {
    ...
    */
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        this.mState.mRunSimpleAnimations = this.mFirstLayoutComplete && this.mItemAnimator != null && ((z = this.mDataSetHasChangedAfterLayout) || z4 || this.mLayout.mRequestedSimpleAnimations) && (!z || this.mAdapter.hasStableIds());
        State state = this.mState;
    ...
    */
    ...
    private void setAdapterInternal(@Nullable Adapter adapter, boolean z, boolean z3) {
    ...
    public String exceptionLabel() {
        return o4.OooO00o.OooO0Oo + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
