            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (f3 > 0.0f) {
                    ...
                    if (((ViewGroup.MarginLayoutParams) layoutParams).width != 0) {
                        ...
                        if (i12 == -2) {
                            iMakeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingTop, i7);
                        } else {
                        ...
                        if (mode2 == i7 && measuredHeight3 > iMin) {
                            iMin = Math.min(measuredHeight3, paddingTop);
                        }
                        i8 -= measuredWidth;
                        boolean z4 = i8 < 0;
                        ...
                        if (!z3 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (((ViewGroup.MarginLayoutParams) layoutParams2).width == 0) {
                                    ...
                                    if (z3) {
                                        i5 = i13;
                                        childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i8)) / f2)), 1073741824), iMakeMeasureSpec);
                                    } else {
                                ...
                                iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredHeight, i4);
                                if (z3) {
                                }
                            }
                            ...
                            iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(measuredHeight2, i6);
                            childAt2.measure(View.MeasureSpec.makeMeasureSpec(i13, i6), iMakeMeasureSpec2);
                        }
                        i5 = i13;
                    }
