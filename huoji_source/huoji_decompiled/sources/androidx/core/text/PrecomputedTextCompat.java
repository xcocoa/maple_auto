...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            int i = Build.VERSION.SDK_INT;
            if (i >= 23 && (this.mBreakStrategy != params.getBreakStrategy() || this.mHyphenationFrequency != params.getHyphenationFrequency())) {
                return false;
            }
            if ((i >= 18 && this.mTextDir != params.getTextDirection()) || this.mPaint.getTextSize() != params.getTextPaint().getTextSize() || this.mPaint.getTextScaleX() != params.getTextPaint().getTextScaleX() || this.mPaint.getTextSkewX() != params.getTextPaint().getTextSkewX()) {
                return false;
            }
    ...
    public static PrecomputedTextCompat create(@NonNull CharSequence charSequence, @NonNull Params params) {
        ...
        try {
            ...
            if (i >= 28 && (params2 = params.mWrapped) != null) {
