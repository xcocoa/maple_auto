...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private Builder(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, boolean z, int i2, boolean z3) {
        ...
        public Action(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z, int i2, boolean z3) {
            this.mShowsUserInterface = true;
            this.icon = i;
        ...
        */
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 24) {
                ...
                Notification.MessagingStyle messagingStyle = i >= 28 ? new Notification.MessagingStyle(person.toAndroidPerson()) : new Notification.MessagingStyle(person.getName());
                ...
                for (Message message : this.mMessages) {
                    ...
                    Notification.MessagingStyle.Message message2 = i >= 28 ? new Notification.MessagingStyle.Message(message.getText(), message.getTimestamp(), person2 == null ? null : person2.toAndroidPerson()) : new Notification.MessagingStyle.Message(message.getText(), message.getTimestamp(), person2 != null ? message.getPerson().getName() : null);
    ...
    public static abstract class Style {
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z3) {
            ...
            boolean z8 = true;
            boolean z9 = this.mBuilder.getPriority() < -1;
            ...
            boolean z10 = i5 < 21 && this.mBuilder.mLargeIcon != null;
            ...
            if (charSequence4 != null) {
                ...
                if (builder4.mNumber <= 0) {
                    ...
                    if (this.mBuilder.getWhenIfShowing() != 0) {
                        z8 = z6;
                    } else if (!this.mBuilder.mUseChronometer || i5 < 16) {
                        int i9 = R.id.time;
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        int i2 = Build.VERSION.SDK_INT;
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, null, i2 >= 24 ? action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES) || action.getAllowGeneratedReplies() : action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES), i2 >= 28 ? action.getSemanticAction() : action.getExtras().getInt(Action.EXTRA_SEMANTIC_ACTION, 0), action.getExtras().getBoolean(Action.EXTRA_SHOWS_USER_INTERFACE, true));
    }
