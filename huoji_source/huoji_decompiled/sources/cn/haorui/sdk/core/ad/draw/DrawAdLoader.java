...
import cn.haorui.sdk.platform.hr.draw.HRDrawHRAdWrapper;

/* JADX INFO: loaded from: classes.dex */
public class DrawAdLoader extends b<DrawAdListener> {
    ...
    public d createDelegate(SdkAdInfo sdkAdInfo, HRAdInfo hRAdInfo) {
        return a.a(sdkAdInfo.getSdk()).drawLoader(this, sdkAdInfo, hRAdInfo);
    }
}
