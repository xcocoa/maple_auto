...
public abstract class ParameterHandler<T> {
    ...
    public static final class Body<T> extends ParameterHandler<T> {
        private final Converter<T, rx> converter;
        private final Method method;
        private final int p;

        public Body(Method method, int i, Converter<T, rx> converter) {
            this.method = method;
            this.p = i;
    ...
    public static final class Headers extends ParameterHandler<jx> {
        private final Method method;
        private final int p;
        ...
        @Override // retrofit2.ParameterHandler
        public void apply(RequestBuilder requestBuilder, @Nullable jx jxVar) {
            if (jxVar == null) {
                throw Utils.parameterError(this.method, this.p, "Headers parameter must not be null.", new Object[0]);
            }
            requestBuilder.addHeaders(jxVar);
        }
    }
    ...
    public static final class Part<T> extends ParameterHandler<T> {
        ...
        public Part(Method method, int i, jx jxVar, Converter<T, rx> converter) {
            this.method = method;
            this.p = i;
            this.headers = jxVar;
            this.converter = converter;
    ...
    public static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        private final Converter<T, rx> valueConverter;

        public PartMap(Method method, int i, Converter<T, rx> converter, String str) {
            this.method = method;
            this.p = i;
            this.valueConverter = converter;
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable Map<String, T> map) throws IOException {
            ...
            for (Map.Entry<String, T> entry : map.entrySet()) {
                ...
                requestBuilder.addPart(jx.OooOO0O("Content-Disposition", "form-data; name=\"" + key + "\"", MIME.CONTENT_TRANSFER_ENC, this.transferEncoding), this.valueConverter.convert(value));
            }
        }
    }
    ...
    public static final class RawPart extends ParameterHandler<nx.OooO0O0> {
        ...
        @Override // retrofit2.ParameterHandler
        public void apply(RequestBuilder requestBuilder, @Nullable nx.OooO0O0 oooO0O0) {
            if (oooO0O0 != null) {
