...
public final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return Utils.typeToString(this.componentType) + kx.OooOOO;
        }
    }
    ...
    public static tx buffer(tx txVar) throws IOException {
        j00 j00Var = new j00();
        txVar.source().OoooOO0(j00Var);
        return tx.create(txVar.contentType(), txVar.contentLength(), j00Var);
    }
