...
public class a {
    ...
    public static String a(int i, float f, float f2) {
        ...
        try {
            ...
            if (i == 4) {
                String str2 = com.anythink.expressad.foundation.g.a.cc;
                iA = com.anythink.expressad.video.bt.a.c.a;
                jSONObject2.put(str2, com.anythink.expressad.video.bt.a.c.a);
                str = com.anythink.expressad.foundation.g.a.cd;
            } else {
                jSONObject2.put(com.anythink.expressad.foundation.g.a.cc, t.a(n.a().f(), f));
                str = com.anythink.expressad.foundation.g.a.cd;
                iA = t.a(n.a().f(), f2);
            }
            jSONObject2.put(str, iA);
            jSONObject2.put(com.anythink.expressad.foundation.g.a.cf, i);
            jSONObject2.put(com.anythink.expressad.foundation.g.a.cg, n.a().f().getResources().getConfiguration().orientation);
            jSONObject2.put(com.anythink.expressad.foundation.g.a.ch, t.c(n.a().f()));
