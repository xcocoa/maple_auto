...
public class b {
    ...
    /* JADX INFO: renamed from: com.anythink.expressad.d.b.b$1, reason: invalid class name */
    public class AnonymousClass1 extends com.anythink.expressad.foundation.g.f.b.b {
        ...
        public final void a(String str) {
            ...
            b.this.f = str;
            b.b(b.this, str);
            com.anythink.expressad.foundation.a.a.a.a().a(b.b, this.a);
        }
    ...
    /* JADX INFO: renamed from: com.anythink.expressad.d.b.b$2, reason: invalid class name */
    public class AnonymousClass2 implements Runnable {
        ...
        public final void run() throws Throwable {
            try {
                File file = new File(d.b(com.anythink.expressad.foundation.g.c.a.ANYTHINK_OTHER), b.c);
                if (file.exists()) {
                    file.delete();
                }
    ...
    private void a(Context context, String str) {
        ...
        String strA = com.anythink.expressad.foundation.a.a.a.a().a(b);
    ...
    private static String e() {
        try {
            File file = new File(d.b(com.anythink.expressad.foundation.g.c.a.ANYTHINK_OTHER), c);
            ...
            if (aVarB != null && !TextUtils.isEmpty(aVarB.M())) {
                ...
                if (contextE != null) {
                    ...
                    if (TextUtils.isEmpty(strA) || !strA.equals(strM)) {
                        try {
                            new com.anythink.expressad.d.a.a(contextE).a(strM, (com.anythink.expressad.foundation.g.f.h.b) null, new AnonymousClass1(strM));
                        } catch (Exception e2) {
                            e2.getMessage();
                        }
                    }
