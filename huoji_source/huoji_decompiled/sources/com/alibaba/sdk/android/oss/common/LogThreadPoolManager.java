...
public class LogThreadPoolManager {
    ...
    private LogThreadPoolManager() {
        ...
        this.mThreadPool = new ThreadPoolExecutor(1, 1, f.a, timeUnit, new ArrayBlockingQueue(500), new ThreadFactory() { // from class: com.alibaba.sdk.android.oss.common.LogThreadPoolManager.3
