...
public class InternalRequestOperation {
    ...
    public InternalRequestOperation(Context context, final URI uri, OSSCredentialProvider oSSCredentialProvider, ClientConfiguration clientConfiguration) {
        ...
        ox.OooO0O0 oooO0O0OooOo00 = new ox.OooO0O0().OooOOo(false).OooOOoo(false).OooOooo(false).OooO0o0(null).OooOo00(new HostnameVerifier() { // from class: com.alibaba.sdk.android.oss.internal.InternalRequestOperation.2
        ...
        if (clientConfiguration != null) {
            ex exVar = new ex();
            exVar.OooOOo0(clientConfiguration.getMaxConcurrentRequest());
            long connectionTimeout = clientConfiguration.getConnectionTimeout();
            TimeUnit timeUnit = TimeUnit.MILLISECONDS;
            oooO0O0OooOo00.OooO(connectionTimeout, timeUnit).OooOoo(clientConfiguration.getSocketTimeout(), timeUnit).Oooo0O0(clientConfiguration.getSocketTimeout(), timeUnit).OooOOO(exVar);
