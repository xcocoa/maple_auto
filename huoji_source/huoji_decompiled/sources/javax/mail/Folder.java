...
public abstract class Folder implements AutoCloseable {
    ...
    public Folder(Store store) {
        ...
        this.q = property.equalsIgnoreCase(o.d) ? EventQueue.getApplicationEventQueue(executor) : property.equalsIgnoreCase(b.ac) ? session.getEventQueue() : property.equalsIgnoreCase("store") ? store.getEventQueue() : new EventQueue(executor);
    }
