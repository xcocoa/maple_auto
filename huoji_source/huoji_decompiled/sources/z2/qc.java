...
public class qc extends hc {
    private static final String OooO0OO = "qc";
    private static qc OooO0Oo;
    ...
    public qc OooO(OooO00o oooO00o) {
    ...
    public void OooOO0(Context context, String str, String str2, OooO00o oooO00o) {
        try {
            this.OooO0O0 = oooO00o;
            EditDeviceNameRequestInfo editDeviceNameRequestInfo = new EditDeviceNameRequestInfo(gc.OooO0OO().OooO00o(context));
            editDeviceNameRequestInfo.ScriptId = str;
            editDeviceNameRequestInfo.DeviceName = str2;
            String string = j3.OooO(j3.OooOOOo, k3.o000000O, k3.o0000O0).build().toString();
            this.OooO00o.OooOO0(context, getClass().getCanonicalName(), string, gc.OooO0OO().OooO(string, editDeviceNameRequestInfo));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
