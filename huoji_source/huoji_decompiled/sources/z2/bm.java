...
public final class bm extends yl {
    ...
    public bm(byte[] bArr, int i, int i2, int i3, int i4, int i5, int i6, boolean z) {
        super(i5, i6);
        if (i3 + i5 > i || i4 + i6 > i2) {
    ...
    public final yl OooO00o(int i, int i2, int i3, int i4) {
        return new bm(this.OooO0OO, this.OooO0Oo, this.OooO0o0, this.OooO0o + i, this.OooO0oO + i2, i3, i4, false);
    }
