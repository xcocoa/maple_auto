...
public class ad extends hc {
    private static ad OooO0OO;
    ...
    public ad OooO(OooO00o oooO00o) {
    ...
    public void OooOO0(Context context, String str, String str2, OooO00o oooO00o) {
        try {
            this.OooO0O0 = oooO00o;
            UploadInstanceDataRequestInfo uploadInstanceDataRequestInfo = new UploadInstanceDataRequestInfo(gc.OooO0OO().OooO00o(context));
            uploadInstanceDataRequestInfo.ScriptId = str;
            uploadInstanceDataRequestInfo.InstanceData = str2;
            String string = j3.OooO(j3.OooOOOo, k3.o000000O, k3.o000OO).build().toString();
            this.OooO00o.OooOO0(context, getClass().getCanonicalName(), string, gc.OooO0OO().OooO(string, uploadInstanceDataRequestInfo));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
