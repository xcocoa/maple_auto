...
public final class xl extends yl {
    private final yl OooO0OO;

    public xl(yl ylVar) {
        super(ylVar.OooO0o0(), ylVar.OooO0O0());
        this.OooO0OO = ylVar;
    }

    @Override // z2.yl
    public final yl OooO() {
        return new xl(this.OooO0OO.OooO());
    }

    @Override // z2.yl
    public final yl OooO00o(int i, int i2, int i3, int i4) {
        return new xl(this.OooO0OO.OooO00o(i, i2, i3, i4));
    }
    ...
    @Override // z2.yl
    public final yl OooOO0() {
        return new xl(this.OooO0OO.OooOO0());
    }
}
