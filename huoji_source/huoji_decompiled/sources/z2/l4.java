...
public class l4 {
    ...
    public class OooO00o implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            if (l4.this.OooO0Oo != null) {
                l4.this.OooO0Oo.OnLocationChange(location);
            }
        }
    ...
    public static l4 OooO0O0(Context context) {
        if (OooO0o0 == null) {
            OooO0o0 = new l4(context);
        }
        return OooO0o0;
    }
