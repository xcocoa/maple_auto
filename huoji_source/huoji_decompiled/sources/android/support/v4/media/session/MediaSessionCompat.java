        ...
        */
        public RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (bundle.containsKey(MediaMetadataCompat.METADATA_KEY_ART)) {
                bitmapCopy = (Bitmap) bundle.getParcelable(MediaMetadataCompat.METADATA_KEY_ART);
                if (bitmapCopy != null) {
                    bitmapCopy = bitmapCopy.copy(bitmapCopy.getConfig(), false);
                }
                metadataEditorEditMetadata.putBitmap(100, bitmapCopy);
            } else if (bundle.containsKey(MediaMetadataCompat.METADATA_KEY_ALBUM_ART)) {
                bitmapCopy = (Bitmap) bundle.getParcelable(MediaMetadataCompat.METADATA_KEY_ALBUM_ART);
                if (bitmapCopy != null) {
                }
                metadataEditorEditMetadata.putBitmap(100, bitmapCopy);
            }
